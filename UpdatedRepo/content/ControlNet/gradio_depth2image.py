...
model.load_state_dict(load_state_dict('./models/control_sd15_depth.pth', location='cuda'), strict=False)
model = model.cuda()
...
with block:
    ...
    with gr.Row():
        ...
        with gr.Column():
            # AGGIORNAMENTO: rimossa la concatenazione .style e integrato columns=2
